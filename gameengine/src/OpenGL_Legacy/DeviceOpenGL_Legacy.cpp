...
void DeviceOpenGL_Legacy::useProgram( int /*unused*/ )
{
}

ContextInfo DeviceOpenGL_Legacy::initContextVersion( LOGLW::IWindow* /*unused*/ )
{
    return ContextInfo();
}
...
void DeviceOpenGL_Legacy::vertexAttribPointer( const VertexData& /*unused*/ )
{
}
...
void DeviceOpenGL_Legacy::draw( const Point& /*unused*/, const ColorS& /*unused*/ )
{
}
...
void DeviceOpenGL_Legacy::translate( const Point& /*unused*/ )
{
}
...
void DeviceOpenGL_Legacy::rotate( const CUL::MATH::Rotation& /*unused*/ )
{
}
...
void DeviceOpenGL_Legacy::scale( const CUL::MATH::Vector3Df& /*unused*/ )
{
}

void DeviceOpenGL_Legacy::scale( const float /*unused*/ )
{
}

void DeviceOpenGL_Legacy::setDepthTest( const bool /*unused*/ )
{
}

void DeviceOpenGL_Legacy::setBackfaceCUll( const bool /*unused*/ )
{
}

void DeviceOpenGL_Legacy::setTexuring( const bool /*unused*/ )
{
}
...
void DeviceOpenGL_Legacy::setActiveTextureUnit( ETextureUnitIndex /*unused*/ )
{
}

void DeviceOpenGL_Legacy::bindTexture( const unsigned int /*unused*/ )
{
}
