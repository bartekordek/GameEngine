...
public:
    ...
    DebugSystemDX12( const DebugSystemDX12& ) = delete;
    DebugSystemDX12( DebugSystemDX12&& ) = delete;
    DebugSystemDX12& operator=( const DebugSystemDX12& ) = delete;
    DebugSystemDX12& operator=( DebugSystemDX12&& ) = delete;
