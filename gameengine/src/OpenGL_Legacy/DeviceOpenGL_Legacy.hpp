...
private:
    ...
    virtual unsigned int getAttribLocation( unsigned programId, const String& attribName ) override;
    virtual unsigned int getUniformLocation( unsigned programId, const String& attribName ) override;
